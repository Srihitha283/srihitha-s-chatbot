...
def new_order(parameter: dict, session_id: str):
    if session_id not in inprogress_order:
        fulfillment_text = "I'm having a trouble in placing your order. Sorry! Can you place a new order please?"
    else:
...
def complete_order(parameters: dict, session_id: str):
    if session_id not in inprogress_order:
        ...
        if order_id == -1:
            return "Sorry, I couldn't process your order due to a backend error. " \
...
def add_to_order(parameters: dict, session_id: str):
    ...
    if len(food_items) != len(quantities):
        ...
        if session_id in inprogress_order:
            ...
            # Add to the quantities of existing food items
